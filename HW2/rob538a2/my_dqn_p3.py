...
def train():
    dqn = DQN(4)
    writer = SummaryWriter('runs/rob538a2/p3')
    ...
    for i_episode in tqdm(range(1000)):
        ...
        for t in range(5000):
            ...
            dqn.store_transition_1(state_1, action_1, reward, next_state, done)
            dqn.store_transition_2(state_2, action_2, reward, next_state, done)
    ...
    # save model
    torch.save(dqn.eval_net_1.state_dict(), 'dqn_2agents_p3_a1.pth')
    torch.save(dqn.eval_net_2.state_dict(), 'dqn_2agents_p3_a2.pth')
    writer.close()
